...
-- Query 4, changes description of the hummer
UPDATE inventory
SET inv_description = 
REPLACE(inv_description, 'small interiors', 'a huge interior')
WHERE inv_id = 10;

-- Query 6, corrects the image file paths
UPDATE inventory
SET inv_image = 
